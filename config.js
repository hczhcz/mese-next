...
module.exports.meseEngine = './mese';
module.exports.meseMaxPlayer = 32;
module.exports.meseMinDataSize = 4096; // for db data protection

module.exports.rtmeseDelta = 0.01;
module.exports.rtmeseInterval = 1000;
